...
import 'admin/pages/add.dart';
import 'admin/pages/remove.dart';

import 'admin/pages/list.dart';
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ParkingAddPage()));
                    },
                    child: _buildContainer("Add", Icons.add),
                  ),
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ParkingRemovePage()));
                    },
              ...
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      Navigator.push(context, MaterialPageRoute(builder: (context) => ParkingListPage()));
                    },
